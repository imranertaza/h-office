<aside class="sidebar secondary sidebar-1 col-sm-3 ac-hide-until-ready ac-hidden-until-ready" role="complementary">
    <section id="search-2" class="widget widget_search">
        <form role="search" method="get" id="searchform" class="form-inline" action="http://h-office.com/">
    ...
    <section id="recent-posts-2" class="widget widget_recent_entries">
        ...
        <ul>
            <li>
                <a href="../the-savings-include-a-us140-a134-stateroom-credit-on/index.html">THE SAVINGS INCLUDE A $US140 ($A134) STATEROOM CREDIT ON</a>
            </li>
            <li>
                <a href="../googlebuslaunch/index.html">FORMAL LAUNCH OF ‘GOOGLE BUS’ IN BANGLADESH</a>
            </li>
            <li>
                <a href="../madeinbangladesh/index.html">MIB SPIRIT MADE IN BANGLADESH</a>
            </li>
        </ul>
    </section>
    ...
    <section id="categories-2" class="widget widget_categories">
        ...
        <ul>
            <li class="cat-item cat-item-18"><a href="../category/experience/index.html">Experience</a></li>
            <li class="cat-item cat-item-2"><a href="../category/food/index.html">Food</a></li>
            <li class="cat-item cat-item-12"><a href="../category/product/index.html">Product</a></li>
            <li class="cat-item cat-item-3"><a href="../category/studio/index.html">Studio</a></li>
            <li class="cat-item cat-item-1"><a href="../category/uncategorized/index.html">Uncategorized</a></li>
        </ul>
    </section>
    <section id="ac_latest_portfolio-1" class="widget ac-latest-portfolio">
        <h3 class="widget-title"></h3>
        <div class="ac-grid-col post-172 ac_portfolio type-ac_portfolio status-publish has-post-thumbnail hentry col-log-3 all experience ac-hide-until-ready ac-hidden-until-ready">
            <div class="ac-grid-post">
                ...
                <div class="text">
                    ...
                    <div class="ac-grid-terms"><a href="../portfolio-category/experience/index.html" rel="tag">Experience</a></div>
                    ...
                    <div class="read-more"><a href="../portfolios/google-bus-bangladesh/index.html">Continued</a></div>
                </div>
            </div>
        </div>
    </section>
