...
@section('styles')
    ...
    #prev { background: url('assets/wp-content/plugins/logo-slider/arrows/arrow1.png') no-repeat center; float: right;
    margin-right: -50px; }
    #next { background: url('assets/wp-content/plugins/logo-slider/arrows/arrow1-prev.png') no-repeat center; float: left;
    margin-left: -50px; }
