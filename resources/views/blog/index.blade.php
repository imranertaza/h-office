        ...
        <div class="content">
            <div class="row bg">
                <main class="main sidebar-1 col-sm-9" role="main">
                    <article
                        class="post-130 page type-page status-publish hentry ac-hide-until-ready ac-hidden-until-ready">
                        <div class="entry-content">
                                                ...
                                                <div class="list-posts">
                                                    @foreach ($blogs as $blog)
                                                        @php
                                                            ...
                                                            $hasThumbnail = !empty($blog->featured_image)
                                                                ? 'has-post-thumbnail'
                                                                : '';
                                                        ...
                                                        <article
                                                            ...
                                                            <header>
                                                                ...
                                                                <div class="row row-meta">
                                                                    <span class="date">
                                                                        ...
                                                                        <a href="{{ route('blog.show', $blog->slug) }}"
                                                                            title="Permalink to {{ $blog->blog_title }}"
                                                                            rel="bookmark">
                                                                    ...
                                                                    <span class="author vcard">
                                                                        ...
                                                                        <a class="url fn n"
                                                                            href="{{ route('blogs', $blog->createdBy) }}"
                                                                    ...
                                                                    <span class="categories-links">
                                                                        ...
                                                                        @forelse ($blog->categories as $category)
                                                                            <a href="{{ route('blogs', $category->category_name) }}"
                                                                                rel="category tag">
                                                                        ...
                                                                        @empty
                                                                            ...
                                                                            <a href="{{ route('blogs', 'uncategories') }}"
                                                                                rel="category tag">
                                                                                Uncategories
                                                                            </a>
                                                                        @endforelse
                                                            ...
                                                            <div class="entry-summary">
                                                                ...
                                                                <div class="read-more">
                                                                    <a
                                                                        href="{{ route('blog.show', $blog->slug) }}">Continued</a>
                                                                </div>
                            ...
                            <div class="btn-group social-share">
                                ...
                                <a class="social-link btn btn-default btn-small"
                                    href="http://www.facebook.com/sharer.php?u=http://h-office.com/blog/&amp;title=Blog"
                                ...
                                <a class="social-link btn btn-default btn-small"
                                    href="http://pinterest.com/pin/create/button/?url=http://h-office.com/blog/"
